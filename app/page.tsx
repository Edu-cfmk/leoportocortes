...
import { Scissors, MapPin, Instagram, Youtube, Clock, Phone } from "lucide-react"
...
export default function Home() {
  return (
    <main className="min-h-screen bg-zinc-950 text-zinc-100 pb-10">
      ...
      {/* 2. Seção de Cartões de Info (A pegada do outro app) */}
      <section className="max-w-4xl mx-auto px-4 mt-8 grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <Card className="bg-zinc-900 border-zinc-800 text-zinc-100">
          <CardContent className="p-5 space-y-3">
            ...
            <p className="text-sm text-zinc-400">Siga nosso Instagram para ver cortes e inspiração.</p>
            <div className="flex gap-2">
              ...
              <Button size="sm" className="bg-red-600 hover:bg-red-700 text-white gap-1.5 text-xs">
                <Youtube className="w-4 h-4" /> WhatsApp
              </Button>
            </div>
          </CardContent>
        </Card>
      ...
      {/* 3. Seção Nossos Cortes (A pegada do outro app) */}
      ...
      {/* 4. Seção Agende seu horário (A pegada do outro app) */}
