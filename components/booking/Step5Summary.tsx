  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-2 text-red-500 font-semibold">
        ...
        <h2 className="text-lg text-white">Passo 5: Resumo do Agendamento</h2>
      </div>

      <div className="bg-zinc-950 border border-zinc-800 rounded-xl p-4 space-y-3 text-sm text-zinc-300">
